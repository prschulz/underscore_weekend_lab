...
describe('first', function(){
  ...
  it('should be able to accept a user-defined index first([1,2,3],2) should return [1,2]',function(){
    expect(myFunctions.first([1,2,3],2)).to.include.members([1,2]);
  });
});
...
describe('last', function() {
  ...
  it('should accept an index argument', function(){
    expect(myFunctions.last([1,2,3],2)).to.include.members([2,3]);
  });

  it('should return nothing if zero is passed in as the index',function(){
    expect(myFunctions.last([1,2,3],0)).to.include.members([]);
  });

  it('should return all the array\'s elements if the index argument is larger than the length of the array', function(){
    expect(myFunctions.last([1,2,3],4)).to.include.members([1,2,3]);
  });
...
describe('uniq', function() {
  it('should return all unique values contained in an unsorted array',function(){
    expect(myFunctions.uniq([1,2,3,1,2,3])).to.include.members([1,2,3]);
  });
...
describe('contains', function() {
  it('should return false if a collection does not contain a user-specified value',function(){
    expect(myFunctions.contains([1,2,3],5)).to.equal(false);
  });
